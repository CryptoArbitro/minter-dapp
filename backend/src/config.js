...
const extraMetadata = {
  external_url: "https://discord.gg/TzFV9EyJZT", // Replace with your website or remove this line if you do not have one.
};
...
const ROYALTY_SHARE = 3500; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x7BEfCFD6094bcA59ea2983Ec480e3fADfFFE8680"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x7BEfCFD6094bcA59ea2983Ec480e3fADfFFE8680"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Free part of the Crypto Referees Collection"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeiadzzw34gx4y2msuaoz2b5mcvzeavfi2c7prxsjoyqsskbck77rse"; // Replace with your generic image that will display for all NFTs pre-reveal.
